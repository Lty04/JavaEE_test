...
public interface PointRecordRepository extends JpaRepository<PointRecord, Long> {
    ...
    @Query("SELECT p FROM PointRecord p WHERE p.user.id = :userId ORDER BY p.createTime DESC")
    Page<PointRecord> findUserPointRecords(@Param("userId") Long userId, Pageable pageable);
